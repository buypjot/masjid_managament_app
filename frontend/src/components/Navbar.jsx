...
export const Navbar = () => {
  ...
  // The premium login experience owns the full viewport and has its own branding.
          ...
          <div className="flex items-center space-x-4">
            {isAdminAuthenticated && isAdminPage ? (
              <div className="flex items-center space-x-4">
                ...
                <button onClick={handleAdminLogout} className="flex items-center space-x-1.5 px-3.5 py-1.5 rounded-lg bg-rose-950/50 hover:bg-rose-900/80 border border-rose-800/60 text-rose-300 text-xs font-medium transition-colors">
              ...
              <div className="flex items-center space-x-4">
                ...
                <button onClick={handleUserLogout} className="flex items-center space-x-1.5 px-3.5 py-1.5 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-300 text-xs font-medium transition-colors">
                  <LogOut className="w-3.5 h-3.5" />
                  <span>Logout</span>
                </button>
              </div>
              ...
              <div className="flex items-center space-x-3">
                <Link to="/signup" className="px-4 py-2 text-xs font-semibold rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white shadow-md shadow-emerald-900/30 transition-all hover:scale-105">Register Masjid</Link>
                <Link to="/login" className="px-3.5 py-2 text-xs font-medium rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-700 transition-colors">Masjid Login</Link>
                <Link to="/admin/login" className="px-3 py-2 text-xs font-medium text-slate-400 hover:text-white flex items-center space-x-1 transition-colors">

    ...
    <div className="mds-reference-dashboard relative min-h-screen overflow-hidden bg-[#f5f7fb] font-sans text-slate-900">
      ...
      <main className="relative z-10 mx-auto max-w-[1500px] space-y-6 px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
        ...
        <section className="grid grid-cols-1 gap-5 lg:grid-cols-[1fr_1.4fr]">
          ...
          <div className="relative min-h-[250px] overflow-hidden rounded-3xl border border-emerald-100/80 bg-gradient-to-br from-[#edf9f5] via-[#e5f6f2] to-[#dff2ed] p-6 shadow-sm sm:p-7"><div className="absolute inset-0 bg-[radial-gradient(circle_at_15%_20%,rgba(255,255,255,.75),transparent_35%),radial-gradient(circle_at_80%_10%,rgba(16,185,129,.08),transparent_30%)]" /><div className="relative z-20 w-full max-w-[68%] pr-2 sm:max-w-[64%] lg:max-w-[62%]"><div className="inline-flex items-center gap-2 rounded-full border border-emerald-100 bg-white/85 px-3 py-1.5 text-xs font-black uppercase tracking-wider text-emerald-700 shadow-sm"><ShieldCheck className="h-4 w-4" />Secure workspace</div><h2 className="mt-4 text-2xl font-black leading-tight tracking-tight text-emerald-900 sm:text-[25px]">Everything your Masjid team needs, in one place.</h2><p className="mt-2 w-full max-w-2xl overflow-visible text-sm leading-6 text-slate-600">Use the navigation to manage community members, collections, properties and reports while keeping your existing live data connected.</p></div><div className="pointer-events-none absolute bottom-0 right-0 h-full w-[46%] sm:w-[52%]"><div className="absolute inset-0 bg-gradient-to-l from-transparent via-transparent to-[#e5f6f2]/70 z-10" /><img src="https://d26e3f10zvrezp.cloudfront.net/Gallery/642ea320-601b-4b12-b6d4-65b35c7245c5-1024x1024.webp" alt="" className="absolute bottom-0 right-0 h-full w-full object-cover object-right-bottom mix-blend-multiply opacity-75" /></div></div>
        </section>
      </main>

...
import {
  Search, Bell, Plus, Users, Wallet, Hourglass, Layers3, ArrowUpRight,
  ArrowRight, X, Settings, LogOut, ChevronDown, ShieldCheck,
  ...
  return (
    <div className="mds-reference-dashboard relative min-h-screen overflow-hidden bg-[#f5f7fb] font-sans text-slate-900">
      ...
      <main className="relative z-10 mx-auto max-w-[1500px] space-y-6 px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
        <motion.section initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} className="mds-hero relative overflow-hidden rounded-[28px] p-6 text-white shadow-2xl sm:p-8">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_20%,rgba(255,255,255,.16),transparent_22%),radial-gradient(circle_at_95%_80%,rgba(255,255,255,.10),transparent_20%)]" />
          <div className="absolute -left-24 -top-24 h-72 w-72 rounded-full bg-emerald-300/15 blur-3xl" />
          <div className="absolute bottom-[-120px] right-[28%] h-80 w-80 rounded-full bg-cyan-300/10 blur-3xl" />
          <div className="mds-hero-mosque" aria-hidden="true">
            <img src="https://d26e3f10zvrezp.cloudfront.net/Gallery/642ea320-601b-4b12-b6d4-65b35c7245c5-1024x1024.webp" alt="" />
          </div>
        ...
        <section className="grid grid-cols-1 gap-5 lg:grid-cols-[1fr_1.4fr]">
          ...
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-600 via-violet-600 to-cyan-500 p-6 text-white shadow-xl shadow-indigo-500/20"><div className="absolute -right-16 -top-16 h-48 w-48 rounded-full bg-white/10 blur-2xl" /><div className="relative z-10 max-w-[62%] sm:max-w-md"><div className="inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-1.5 text-xs font-black uppercase tracking-wider"><ShieldCheck className="h-4 w-4" />Secure workspace</div><h2 className="mt-4 text-2xl font-black tracking-tight">Everything your Masjid team needs, in one place.</h2><p className="mt-2 text-sm leading-6 text-white/75">Use the navigation to manage community members, collections, properties, services and reports while keeping your existing live data connected.</p></div><svg className="pointer-events-none absolute bottom-0 right-0 h-full w-[58%] max-w-[340px] opacity-90" viewBox="0 0 320 220" preserveAspectRatio="xMaxYMax slice" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><circle cx="248" cy="54" r="30" fill="rgba(255,255,255,0.18)" /><circle cx="284" cy="34" r="14" fill="rgba(255,255,255,0.14)" /><path d="M0 220V150C10 150 10 138 22 138C34 138 34 150 46 150V220H0Z" fill="rgba(255,255,255,0.10)" /><path d="M60 220V128C68 128 68 118 78 118C88 118 88 128 96 128V220H60Z" fill="rgba(255,255,255,0.14)" /><rect x="112" y="150" width="16" height="70" rx="2" fill="rgba(255,255,255,0.16)" /><rect x="196" y="150" width="16" height="70" rx="2" fill="rgba(255,255,255,0.16)" /><path d="M118 150C118 138 122 130 120 118C118 108 122 100 120 92C118 84 122 78 120 70C119 66 121 62 120 58C119 62 121 66 120 70C118 78 122 84 120 92C118 100 122 108 120 118C118 130 122 138 122 150H118Z" fill="rgba(255,255,255,0.22)" /><path d="M204 150C204 138 208 130 206 118C204 108 208 100 206 92C204 84 208 78 206 70C205 66 207 62 206 58C205 62 207 66 206 70C204 78 208 84 206 92C204 100 208 108 206 118C204 130 208 138 208 150H204Z" fill="rgba(255,255,255,0.22)" /><path d="M96 220V132C96 108 116 90 152 90C188 90 208 108 208 132V220H96Z" fill="rgba(255,255,255,0.24)" /><path d="M152 90C138 90 128 78 128 66C128 50 140 40 152 26C164 40 176 50 176 66C176 78 166 90 152 90Z" fill="rgba(255,255,255,0.26)" /><rect x="146" y="10" width="4" height="20" rx="2" fill="rgba(255,255,255,0.3)" /><circle cx="148" cy="8" r="4" fill="rgba(255,255,255,0.3)" /><path d="M118 220V184C118 176 128 170 138 170C148 170 158 176 158 184V220H118Z" fill="rgba(255,255,255,0.5)" /><path d="M146 190C146 184 149 180 152 176C155 180 158 184 158 190C158 195 155 198 152 198C149 198 146 195 146 190Z" fill="rgba(255,255,255,0.45)" /></svg></div>
        </section>
      </main>
